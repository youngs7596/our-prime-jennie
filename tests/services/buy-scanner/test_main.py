...
class TestBuyScannerMain(unittest.TestCase):
    ...
    def test_scan_safety_mode_monitor_alive(self):
        """Monitor가 살아있으면 신호 발송을 안 해야 함"""
        with patch.object(main.database, 'get_redis_connection') as mock_get_redis:
    ...
    # @unittest.skip("CI Stabilization: Fallback logic changed, needs investigation")
    def test_scan_fallback_mode_monitor_dead(self):
    ...
    def test_scan_config_disabled_safety(self):
