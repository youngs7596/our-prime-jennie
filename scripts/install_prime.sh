...
echo -e "${GREEN}================================================================${NC}"
echo -e "${CYAN}📖 설치 가이드: INSTALL_GUIDE.md${NC}"
...
echo -e "\n${CYAN}📋 다음 단계:${NC}"
echo -e ""
echo -e "1. Docker 권한 적용 (필수):"
echo -e "   ${YELLOW}newgrp docker${NC}  # 이 명령어를 실행해야 Docker 권한이 적용됩니다."
echo -e ""
echo -e "2. Python 환경 활성화:"
echo -e "   ${YELLOW}source venv/bin/activate${NC}"
echo -e ""
echo -e "3. Docker 서비스 시작 (프로파일 선택):"
echo -e ""
