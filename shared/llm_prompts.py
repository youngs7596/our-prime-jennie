...
def build_debate_prompt(stock_info: dict, hunter_score: int = 0, keywords: list = None) -> str:
    ...
    **단순한 말싸움이 아니라, '{primary_theme}' 산업의 특성을 반영한 깊이 있는 논쟁이어야 합니다.**
    ...
    [팩트 체크(Fact Check) 규칙 - 중요]
    1. **제공된 뉴스/데이터에 없는 구체적인 수치(예: 'RSI가 85다', '영업이익률이 3% 줄었다')를 절대 창조(Hallucination)하지 마세요.**
    2. 모든 주장에 근거를 태깅하세요 (가능한 경우). 
...
def build_hunter_prompt_v5(stock_info: dict, quant_context: str = None, feedback_context: str = None) -> str:
    ...
    if feedback_context:
        feedback_section = f"""
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
## [Strategic Feedback (Lessons Learned)]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
AI Analyst가 과거 실패 사례를 분석하여 도출한 교훈입니다. 이 내용을 반드시 준수하세요.
