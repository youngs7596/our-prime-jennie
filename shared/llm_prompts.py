...
## 출력 형식 (반드시 준수)
{{"score": 72, "grade": "A", "reason": "정량 75점이나 이미 뉴스 반영되어 +2점만 보수적으로 반영하는 등... (줄바꿈 금지)"}}
